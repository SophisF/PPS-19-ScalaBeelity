...
|-----------------------------------------------------------------------------	|------------------------------------------------------------------------------------------------------	|-----------------------	|----------------------------	|---	|---	|---	|---	|---	|---	|
| Product Backlog Item                                                        	| Sprint Task                                                                                          	| Volunteer             	| Initial Estimate of Effort 	| 1     | 2     | 3 	| 4 	| 5 	| 6 	|
| I need to perfect environment							| create generator of continuous filter 								| Baldini & Gnagnarella		| 4				| 4	| 4	| 1	| 1	| 0	| 0	|
|										| change parameter for range of properties								| Baldini & Gnagnarella		| 1				| 1	| 0	| 0	| 0	| 0	| 0	|
| I need to implement a functional looper					| evaluated monad's element										| Baldini & Gnagnarella		| 7				| 7	| 7	| 7	| 7	| 7	| 6	|
| I need to simulate bees’ life                                               	| interaction with the environment                                                                     	| Fantoni & Scucchia    	| 8                          	| 7	| 7 	| 7  	| 6  	| 6  	| 0  	|
|                                                                             	| interaction between different colonies                                                               	| Fantoni & Scucchia    	| 8                          	| 8	| 7 	| 4  	| 1  	| 1  	| 1  	|
|                                                                             	| evolution of a colonies                                                                              	| Fantoni & Scucchia    	| 8                          	| 6 	| 6 	| 5  	| 2  	| 1  	| 1 	|
|                                                                             	| casual mutation of bees                                                                              	| Fantoni & Scucchia    	| 6                          	| 6	| 1	| 1  	| 1  	| 0  	| 0  	|
| I need to visualize some charts with simulation data                        	| visualization of some bees’ average characteristics                                                  	|                       	| 4                          	|       |       |   	|   	|   	|   	|
|                                                                             	| visualization of yearly environment changes                                                          	|                       	| 4                          	|       |       |   	|   	|   	|   	|
| I need to control some basic simulation parameters (e.g., time granularity) 	| simulation speed control                                                                             	|                       	| 3                          	|       |       |   	|   	|   	|   	|
|                                                                             	| give the user the opportunity to select some parameters in range (i.e., temperature, pressure, etc.) 	|                       	| 5                          	|       |       |   	|   	|   	|   	|
...
5 settembre - 16 settembre		New Estimates of effort remaining at the end of day 
