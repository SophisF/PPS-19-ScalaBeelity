...
object EvolutionManager {
   ...
   */
  def evolveGenotype(genotype: Genotype)(averageTemperature: Int)(averagePressure: Int)(averageHumidity: Int)(time: Int): Genotype = {
    ...
    def createGenotype(genes: List[Gene], newGenes: List[Gene] = List.empty): List[Gene] = genes match {
      case h :: t => val gene = h taxonomy match {
        case GeneTaxonomy.TEMPERATURE_GENE => environmentalAdaptation(h taxonomy)(h frequency)(phenotype expressionOf CharacteristicTaxonomy.TEMPERATURE_COMPATIBILITY)(averageTemperature)(evolutionaryRate)
        case GeneTaxonomy.PRESSURE_GENE => environmentalAdaptation(h taxonomy)(h frequency)(phenotype expressionOf CharacteristicTaxonomy.PRESSURE_COMPATIBILITY)(averagePressure)(evolutionaryRate)
        case GeneTaxonomy.HUMIDITY_GENE => environmentalAdaptation(h taxonomy)(h frequency)(phenotype expressionOf CharacteristicTaxonomy.HUMIDITY_COMPATIBILITY)(averageHumidity)(evolutionaryRate)
